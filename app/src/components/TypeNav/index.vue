...
//引入方式：把lodash全部功能函数引入  import _ from 'lodash'
//最好按需加载
...
export default {
  ...
  methods: {
    ...
    goSearch(event){
      ...
      // 节点有一个属性，dataset可以获取节点的自定义属性与属性值
      //es6解构赋值
      let {categoryname,category1id,category2id,category3id} = element.dataset
      //如果标签的身上有categoryname一定是a标签
      if(categoryname){
         //整理路由跳转的参数
        ...
        //判断：如果路由跳转的时候，带有paramas参数，捎带传递过去
